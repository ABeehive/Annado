...
use commands::{
    ...
    get_excluded_paths, set_excluded_paths, get_excluded_tags, set_excluded_tags, set_annado_exclude_in_file,
    write_plugin_shared_config, remove_plugin_shared_config, read_plugin_shared_config,
    get_used_with_obsidian_plugin, set_used_with_obsidian_plugin, ensure_shared_config_watcher,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            write_plugin_shared_config,
            remove_plugin_shared_config,
            read_plugin_shared_config,
            get_used_with_obsidian_plugin,
            set_used_with_obsidian_plugin,
            ensure_shared_config_watcher,
            create_project,
            rename_project,
            create_person,
            rename_person,
